...
const Navbar = () => {
  ...
  return (
    <header className="fixed top-0 w-full bg-white dark:bg-gray-900 shadow-md dark:shadow-gray-800 z-50">
      ...
      {/* Mobile Navigation */}
      <div
        className={`fixed inset-0 bg-black/50 z-40 ${navOpen ? "block" : "hidden"}`}
        onClick={closeNav}
      />
      <div
